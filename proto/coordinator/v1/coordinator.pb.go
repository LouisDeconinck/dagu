...
func (x *Task) GetBaseConfigWorkspace() string {
	if x != nil && x.BaseConfigWorkspace != nil {
		return *x.BaseConfigWorkspace
	}
	return ""
}
...
func (x *Task) HasBaseConfigWorkspace() bool {
	...
	return x.BaseConfigWorkspace != nil
}
...
type ClaimAgentSessionCleanupResponse struct {
	...
	OwnerCoordinatorId   string                 `protobuf:"bytes,7,opt,name=owner_coordinator_id,json=ownerCoordinatorId,proto3" json:"owner_coordinator_id,omitempty"`
	OwnerCoordinatorHost string                 `protobuf:"bytes,8,opt,name=owner_coordinator_host,json=ownerCoordinatorHost,proto3" json:"owner_coordinator_host,omitempty"`
	OwnerCoordinatorPort int32                  `protobuf:"varint,9,opt,name=owner_coordinator_port,json=ownerCoordinatorPort,proto3" json:"owner_coordinator_port,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type ResolveSecretReferenceRequest struct {
	...
	DagName       string                 `protobuf:"bytes,8,opt,name=dag_name,json=dagName,proto3" json:"dag_name,omitempty"`          // Current DAG definition; empty keeps legacy root behavior
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RuntimeProfileLayer struct {
	...
	Entries       []*RuntimeProfileEntry `protobuf:"bytes,2,rep,name=entries,proto3" json:"entries,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ResolveRuntimeProfileResponse struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Defaults      *RuntimeProfileLayer   `protobuf:"bytes,1,opt,name=defaults,proto3" json:"defaults,omitempty"`
	Selected      *RuntimeProfileLayer   `protobuf:"bytes,2,opt,name=selected,proto3" json:"selected,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
